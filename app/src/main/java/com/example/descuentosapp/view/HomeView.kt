...
fun HomeViewContent(paddingValues: PaddingValues){
    Column(modifier= Modifier
      ...
      //  verticalArrangement = Arrangement.Center,
        ...
        TowCards(title = "Total", number1 = descuentoTotal , title2 = "Descuento" , number2 =descuentoPrecio)
        ...
        MainButton(text = "Generar Descuento") {
            ...
            descuentoTotal = calcularDescuento(precio =precio.toDouble(), descuento = descuento.toDouble())
        }
        SpaceW()
